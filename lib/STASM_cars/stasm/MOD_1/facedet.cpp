...
{
		OpenDetector(facedet_g, "haarcascade_carsideview.xml",  datadir);
}
...
// Simula un detector que localiza el objeto en el mismo lugar siempre.
    ...
    int          minwidth) // in: as percent of img width
{
    ...
    static const int    DETECTOR_FLAGS = 0|cv::CASCADE_SCALE_IMAGE;
